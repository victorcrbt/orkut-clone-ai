...
export default function Login() {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center p-4">
      <div className="w-full max-w-4xl mx-auto flex flex-col shadow-md rounded overflow-hidden">
        {/* Logo e descrição - Responsivo */}
        <div className="p-4 sm:p-8 flex-1 flex flex-col items-center justify-center text-center bg-white">
          <h1 className="text-pink-500 text-4xl sm:text-6xl font-bold mb-4 sm:mb-6">orkut</h1>
          <div className="text-pink-700 text-xs sm:text-sm px-2 sm:px-4">
        ...
        <div className="bg-gray-100 p-4 sm:p-6 flex-1">
          <h2 className="text-gray-700 text-sm sm:text-base mb-4">Acesse o <span className="font-bold">orkut.br</span> com a sua conta</h2>
          ...
          <form onSubmit={handleSubmit}>
            <div className="mb-3">
              <label htmlFor="email" className="block text-gray-700 text-xs sm:text-sm mb-1">E-mail:</label>
              <input
                type="email"
                id="email"
                value={email}
            ...
            <div className="mb-3">
              <label htmlFor="password" className="block text-gray-700 text-xs sm:text-sm mb-1">Senha:</label>
              <input
                type="password"
                id="password"
                value={password}
            ...
            <button
              type="submit"
              className="w-full bg-pink-500 text-white py-2 px-3 rounded-lg hover:bg-pink-600 transition-colors text-xs sm:text-sm"
              disabled={loading}
            >
            ...
            <div className="mt-4">
              <button
                ...
                disabled={loading}
                className="w-full bg-white border border-gray-300 text-gray-700 py-2 px-3 rounded-lg hover:bg-gray-50 transition-colors flex items-center justify-center gap-2 text-xs sm:text-sm"
              >
